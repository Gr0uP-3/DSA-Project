//C PROGRAM TO STORE AND MANAGE STUDENT RECORD
//IN THIS PROGRAM LINKED LIST METHOD USED
// This Project was Completed by Group 3 DS mini project students of Cv Raman Global University
